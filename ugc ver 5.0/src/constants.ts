...
import { VoiceOption, LanguageOption, ToneOption, StoryboardType, ImageResolution } from './types';

export const RESOLUTION_OPTIONS: ImageResolution[] = [
  { value: '1K', label: '1K (Standard)', description: 'Resolusi standar, cepat dan tajam.' },
  { value: '2K', label: '2K (High Detail)', description: 'Lebih tajam, cocok untuk cetak kecil.' },
  { value: '4K', label: '4K (Ultra HD)', description: 'Detail maksimal, kualitas profesional.' },
];
...
export const REALISM_PROMPT = `
ULTRA REALISTIC DETAIL INSTRUCTION:
- Tingkatkan realisme tekstur kulit dan detail permukaan secara menyeluruh pada SELURUH BAGIAN TUBUH yang terlihat (wajah, leher, tangan, lengan, kaki, dll).
- Detail kulit harus terlihat manusiawi dan natural: pori-pori halus, micro skin texture, slight imperfections alami, skin unevenness ringan, transisi warna kulit yang realistis.
- Tingkat ketajaman (sharpness) dan detail visual berada pada level TINGGI, seolah diambil dengan kamera resolusi tinggi dan fokus yang tepat.
- PENTING: Jangan menurunkan kualitas detail meskipun foto sumber memiliki blur ringan. Prioritaskan clarity, edge definition, dan fine detail.
- PASTI KAN: tidak mengubah struktur wajah dan tubuh, identitas personal, usia, ekspresi, dan pose.
- HINDARI: kulit plastik, efek beauty / skin smoothing, airbrushed look, over-sharpen digital, artefak AI.
- HASIL AKHIR: Foto manusia asli dengan detail tajam, tekstur kulit nyata, hasil kamera profesional, bukan ilustrasi AI, bukan hasil filter.
- Keywords: Ultra realistic full-body skin texture, high clarity, sharp detail, natural human skin, no beauty filter.
`;
